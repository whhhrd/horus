...
open class AssignmentDtoBrief {
    ...
    constructor(id: Long, name: String, commentThread: CommentThread?, createdAt: ZonedDateTime) {
        this.id = id
        this.name = name
    ...
    constructor(a: Assignment) : this(a.id, a.name, a.commentThread, a.createdAt)
}