...
export interface StudentDashboardDataRequestSucceededAction
...
export const studentDashboardDataRequestedAction = (cid: number) => ({
    type: STUDENT_DASHBOARD_DATA_REQUESTED_ACTION,
    cid,
});

export const studentDashboardDataRequestSucceededAction = (
    result: StudentDashboardDto,
) => ({
    type: STUDENT_DASHBOARD_DATA_REQUEST_SUCCEEDED_ACTION,
    result,
});
