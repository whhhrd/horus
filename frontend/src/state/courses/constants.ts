...
export const COURSE_LIST_TEACHER = "courseDtoFull-selection/courseDtoFull-list/teacher-mode";
export const COURSE_LIST_ANY = "courseDtoFull-selection/courseDtoFull-list/any-mode";
